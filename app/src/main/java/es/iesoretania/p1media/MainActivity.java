package es.iesoretania.p1media;
...
import es.iesoretania.p1media.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity
{
    ...
    public void media( View view ) {
        ...
        String strFinal;
        if( calc >= 5 )
            strFinal = "Aprobado con " + calc + " de media";
        else
            strFinal = "Suspenso con " + calc + " de media";
